...
Found file (`.github/workflows/helm.yml`).

### ✅ `source-license-headers-exist` <a href="#user-content--source-license-headers-exist" id="-source-license-headers-exist">#</a>

The first 7 lines contain all of the requested patterns. (`charts/firefly/scripts/ff-deploy-erc20-erc721-contracts/index.js`).
