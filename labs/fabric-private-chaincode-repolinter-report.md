...
- `client_sdk/go/pkg/gateway/fakes/contract.go`: The first 7 lines do not contain the pattern(s): Copyright, License.
- `client_sdk/go/pkg/gateway/fakes/encryption_context.go`: The first 7 lines do not contain the pattern(s): Copyright, License.
- `client_sdk/go/pkg/gateway/fakes/encryption_provider.go`: The first 7 lines do not contain the pattern(s): Copyright, License.
- `client_sdk/go/pkg/gateway/fakes/network.go`: The first 7 lines do not contain the pattern(s): Copyright, License.
- `client_sdk/go/pkg/gateway/fakes/transaction.go`: The first 7 lines do not contain the pattern(s): Copyright, License.
- `client_sdk/go/pkg/gateway/internal/adapter.go`: The first 7 lines do not contain the pattern(s): Copyright, License.
- `client_sdk/go/pkg/client/resmgmt/fakes/channelclient.go`: The first 7 lines do not contain the pattern(s): Copyright, License.
...
Found file (`integration/test-network`).
