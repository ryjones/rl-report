...
- `mocks/fftmmocks/manager.go`: The first 7 lines do not contain the pattern(s): Copyright, License.
- `mocks/jsonrpcmocks/client.go`: The first 7 lines do not contain the pattern(s): Copyright, License.
