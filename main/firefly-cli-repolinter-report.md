...
- `internal/docker/docker_checks.go`: The first 7 lines do not contain the pattern(s): Copyright, License.
- `internal/stacks/prometheus_config.go`: The first 7 lines do not contain the pattern(s): Copyright, License.
...
Found file (`internal/core/manifest_test.go`).
